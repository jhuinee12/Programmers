...
public class JavaNumberGame {
     ...
     *
     * 고려사항
     * B팀은 A팀의 출전 순서를 보고 점수가 높도록 출전 순서를 결정
     */
    ...
    public static void main(String args[]) {
        ...
        System.out.println(numberGameJ.solution1(a,b));
        System.out.println(numberGameJ.solution1(c,d));
        System.out.println(numberGameJ.solution1(e,f));

        System.out.println(numberGameJ.solution2(a,b));
        System.out.println(numberGameJ.solution2(c,d));
        System.out.println(numberGameJ.solution2(e,f));

        System.out.println(numberGameJ.solution3(a,b));
        System.out.println(numberGameJ.solution3(c,d));
        System.out.println(numberGameJ.solution3(e,f));
    }
}
