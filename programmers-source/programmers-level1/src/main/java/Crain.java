...
크레인을 모두 작동시킨 후 터트려져 사라진 인형의 개수를 return 하도록 Crain 함수를 완성해주세요.
...
public class Crain {
    public int Crain(int[][] board, int[] moves) {
        int answer = 0;
...
//		int[][] board = {{2,2,2,2,2},{2,2,2,2,2},{2,2,2,2,2},{2,2,2,2,2},{2,2,2,2,2}};
//		int[] moves = {1,5,3,5,1,2,1,4};
        System.out.println(sol.Crain(board, moves));
    }
